...
class MessageBus:
    ...
    def _log_exchange(self, from_agent, to_agent, message, response):
        """Sauvegarder la conversation pour que Catherine puisse la relire."""
