# Checklist d'onboarding — Nouveau client CS Business
...
- [ ] Paiement (ou acompte selon échéancier)
...
2. **CGV** — document standard CS Business (CGV.docx dans Notion)
3. **Facture / échéancier** — montant, dates, moyens de paiement

**Règle d'or :** Ne jamais onboarder sans validation écrite + paiement.
...
### Structure du dashboard (basée sur le modèle Fred Funel)
...
### Contenu
- Présentation de la méthode CS Business
