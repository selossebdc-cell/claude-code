...
| Pattern | Implication |
|---------|------------|
| **Aurélia = validation, pas opérationnel** | Tous les process doivent être déléguables à Laurie/Anam |
| **Laurie débordée** | Automations max priorité |
| **Anam = VA** | Tâches bien structurées, simples, documentées |
...
- [ ] Formation équipe (Laurie + Anam)

---
**Dernière mise à jour**: 2026-04-26  
**Prochaine révision**: Après livraison finale 23/04
